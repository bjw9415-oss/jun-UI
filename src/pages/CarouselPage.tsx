    ...
    <div className="min-h-screen bg-[#0d1117] flex flex-col items-center py-20 px-4">
      ...
      <div className="w-full max-w-7xl flex flex-col lg:flex-row gap-8">
        <div className="flex-1 min-w-0 bg-[#161b22] rounded-2xl border border-gray-800 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-10 min-h-100 bg-[#0a0d12] bg-[radial-gradient(var(--border-default)_1px,transparent_1px)] bg-size-[16px_16px]">
            {/*  캐러셀 실제 렌더링 영역 */}
            <Carousel
                    ...
                    <Card className="relative h-75 sm:h-100 w-full overflow-hidden border-gray-800/50">
                      <CardContent className="p-0 h-full">
                        ...
                        <div className="absolute bottom-10 left-8 right-8 text-white">
                          <span className="inline-block px-3 py-1 bg-primary/20 text-primary border border-primary/30 rounded-full text-xs font-bold mb-3 backdrop-blur-md">
                            Featured 0{slide.id}
                          </span>
        ...
        <div className="w-full lg:w-md shrink-0 flex flex-col gap-6">
          <div className="bg-[#161b22] p-6 rounded-2xl border border-gray-800 flex flex-col gap-6">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              * CSS의{" "}
              <code className="text-primary">transform: translateX()</code>{" "}
