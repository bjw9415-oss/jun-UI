                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="grid gap-2">
                      <div className="grid grid-cols-3 items-center gap-4">
                        ...
                        <input
                          defaultValue="100%"
                          className="col-span-2 h-8 rounded-md bg-[#0d1117] border border-gray-700 px-2 text-xs text-white focus:border-primary outline-none"
                        />
                      </div>
                      <div className="grid grid-cols-3 items-center gap-4">
                    ...
                    <button className="mt-2 w-full bg-primary text-white py-1.5 rounded-lg text-xs font-semibold hover:bg-[#0081cc] transition-colors">
                      적용하기
                    </button>
                  </div>
                }
              >
                <button className="px-5 py-2.5 bg-[#161b22] text-white border border-gray-700 font-medium rounded-xl hover:border-primary transition-all shadow-lg">
                  설정 열기 (Click)
                </button>
              </Popover>
            </div>
