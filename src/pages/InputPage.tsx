                  ...
                  {(["none", "Search", "Mail", "Lock"] as LeftIconType[]).map(
                    (icon) => (
                      <button
                        ...
                        className={`flex-1 py-1.5 text-xs rounded-md border transition-colors ${leftIconName === icon ? "bg-primary border-primary text-white" : "border-gray-700 text-gray-400 hover:bg-secondary"}`}
                      >
                        {icon}
                      </button>
                    ),
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`flex-1 py-1.5 text-xs rounded-md border transition-colors ${rightIconName === "none" ? "bg-primary border-primary text-white" : "border-gray-700 text-gray-400 hover:bg-secondary"}`}
                  >
                    없음
                  </button>
                  <button
                    onClick={() => setRightIconName("Eye")}
                    className={`flex-1 py-1.5 text-xs rounded-md border transition-colors ${rightIconName === "Eye" ? "bg-primary border-primary text-white" : "border-gray-700 text-gray-400 hover:bg-secondary"}`}
                  >
                    눈알 (Eye)
                  </button>
                </div>
